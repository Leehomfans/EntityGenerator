    ...
    public class SqlServer
    {
        ...
        public List<TableInfo> GetTableInfo()
        {
            ...
            using (DataTable dt = conn.GetSchema("Tables"))
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string pkField=GetPKField(tableName);
                    ...
                    GetColumnInfo.ForEach(o =>
                    {
                        ...
                        o.IsPrimaryKey = o.ColumnName == pkField;
                    });
        ...
        public string GetPKField(string tableName)
        {
            ...
            if (dr.HasRows)
            {
                if (dr.Read())
                {
                    PKField = dr["COLUMN_NAME"].ToString();
                }
        ...
        private List<ColumnInfo> GetFileds(string tableName)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                field.Nullable = dr["IS_NULLABLE"].ToString() == "YES" ? true : false;
                _Fields.Add(field);
            }
            return _Fields;
        }
